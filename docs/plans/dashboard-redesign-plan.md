> **ARCHIVED HISTORY — do not edit.** Completed-work snapshot of the Dashboard
> Redesign plan, preserved when `tasks/plan.md` was replaced by the
> coding-engine-proxy-cost feature (branch `dashboard-engine-proxy-cost`,
> 2026-08-26). The active plan lives in `tasks/plan.md`.
